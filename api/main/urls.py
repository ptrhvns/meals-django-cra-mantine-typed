...
urlpatterns: list[URLPattern | URLResolver] = [
    ...
    path("ingredient/<int:ingredient_id>/", views.ingredient, name="ingredient"),
    path("ingredient/<int:ingredient_id>/destroy/", views.ingredient_destroy, name="ingredient_destroy"),
    path("ingredient/<int:ingredient_id>/update/", views.ingredient_update, name="ingredient_update"),
    ...
    path("recipe/<int:recipe_id>/direction/create/", views.direction_create, name="direction_create"),
