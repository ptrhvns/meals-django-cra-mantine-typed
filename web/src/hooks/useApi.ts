...
const API_ROUTES = asRouteDictionary({
  ...
  ingredient: (ingredientId: string) => `/api/ingredient/${ingredientId}/`,
  ingredientAssociate: (recipeId: string) => `/api/ingredient/recipe/${recipeId}/associate/`,
  ingredientDestroy: (ingredientId: string) => `/api/ingredient/${ingredientId}/destroy/`,
  ingredientUpdate: (ingredientId: string) => `/api/ingredient/${ingredientId}/update/`,
  login: () => "/api/login/",
  logout: () => "/api/logout/",
